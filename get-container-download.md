...
Please see the [E4S 25.06 Release Notes](https://oaciss.uoregon.edu/e4s/talks/E4S_25.06.pdf).
...
### Container Releases
  ...
  * [Singularity x86\_64 Download - CPU only](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cpu-x86_64-25.06.sif)
  * [Singularity x86\_64 Download - CUDA 80](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda80-x86_64-25.06.sif)
  * [Singularity x86\_64 Download - CUDA 90](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda90-x86_64-25.06.sif)
  * [Singularity x86\_64 Download - CUDA 120](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda120-x86_64-25.06.sif)
  * [Singularity ppc64le Download - CUDA 70](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda70-ppc64le-25.06.sif)
  * [Singularity aarch64 Download - CPU only](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cpu-aarch64-25.06.sif)
  ...
  * [Singularity x86\_64 Download - OneAPI](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-oneapi-x86_64-25.06.sif)
...
##### AMD ROCm (x86\_64)
  ...
  * ecpe4s/e4s-rocm:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-rocm/tags)
  * e4s-rocm942-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-rocm942-x86_64-25.06.sif)
  * e4s-rocm90a-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-rocm90a-x86_64-25.06.sif)
  * e4s-rocm908-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-rocm908-x86_64-25.06.sif)

##### NVIDIA CUDA (X86\_64, PPC64LE, AARCH64)

  * ecpe4s/e4s-cuda:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-cuda/tags)
  * e4s-cuda80-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda80-x86_64-25.06.sif)
  * e4s-cuda90-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda90-x86_64-25.06.sif)
  * e4s-cuda70-ppc64le-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda70-ppc64le-25.06.sif)
  * e4s-cuda75-aarch64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda75-aarch64-25.06.sif)
  * e4s-cuda80-aarch64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda80-aarch64-25.06.sif)
  * e4s-cuda90-aarch64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cuda90-aarch64-25.06.sif)

##### Intel OneAPI (x86\_64)

  * ecpe4s/e4s-oneapi:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-oneapi/tags)
  * e4s-oneapi-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-oneapi-x86_64-25.06.sif)

##### CPU-only (x86\_64, aarch64)

  * ecpe4s/e4s-cpu:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-cpu/tags)
  * e4s-cpu-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cpu-x86_64-25.06.sif)
  * e4s-cpu-aarch64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-cpu-aarch64-25.06.sif)
...
##### AMD ROCM (X86\_64)
  ...
  * ecpe4s/e4s-base-rocm:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-base-rocm/tags)
  * e4s-base-rocm-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-base-rocm-25.06.sif)

##### NVIDIA Multi-Arch (X86\_64, PPC64LE, AARCH64)

  * ecpe4s/e4s-base-cuda:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-base-cuda/tags)
  * e4s-base-cuda-x86\_64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-base-cuda-x86_64-25.06.sif)
  * e4s-base-cuda-aarch64-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-base-cuda-aarch64-25.06.sif)
  * e4s-base-cuda-ppc64le-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-base-cuda-ppc64le-25.06.sif)

##### Intel OneAPI (X86\_64)

  * ecpe4s/e4s-base-oneapi:25.06 [[docker]](https://hub.docker.com/r/ecpe4s/e4s-base-oneapi/tags)
  * e4s-base-oneapi-25.06.sif [[singularity]](https://oaciss.nic.uoregon.edu/e4s/images/25.06/e4s-base-oneapi-25.06.sif)
