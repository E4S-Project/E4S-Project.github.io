...
layout: single
classes: wide
permalink: /product-catalog-plaintext/
sidebar:
  nav: "usemenu"
---
...
const RAW_DATA = {% assign items = site.data.product-catalog-plaintext.data | default: site.data.product-catalog-plaintext | default: empty %}
